...
| `-e CLI_ARGS=--gameid devtest` | Optionally specify any [CLI variables](https://wiki.luanti.net/Command_line) you want to launch the app with |
| `-v /config/.minetest` | Where luanti stores config files and maps etc. |
